...
use App\OpenApi\Extensions\ApiDocumentationExtension;
...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API do marketplace de tatuadores. Autenticação via Bearer token (Sanctum).',
    ],
    ...
    'extensions' => [
        ApiDocumentationExtension::class,
    ],
